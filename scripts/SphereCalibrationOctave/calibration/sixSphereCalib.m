function [leverArmEstimation, boresightEstimation] = twoSphereCalib(initialPlatParams, dataSphere1, dataSphere2, dataSphere3, dataSphere4, dataSphere5, dataSphere6, r)
  initialPlatParams
  ...
  function cost = f(platParams)
    ...
    georefDataSphere6 = georef(dataSphere6, platParams);
    nodesSphere6 = buildDistanceNetwork(georefDataSphere6, r);
    diffsSphere6 = distanceNetworkRec(nodesSphere6);
    c6 = sum(sqrt(sum(diffsSphere6.^2, 2)));
    ...
    residu6 = calculateResidus(georefDataSphere6, r);
    
    cost = c1 + c2 + c3 + c4 + c5 + c6 + 10*sum(residu1.^2) + 10*sum(residu2.^2) + 10*sum(residu3.^2) + 10*sum(residu4.^2) + 10*sum(residu5.^2) + 10*sum(residu6.^2)
  endfunction
