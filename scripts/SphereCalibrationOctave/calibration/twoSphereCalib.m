function [leverArmEstimation, boresightEstimation] = twoSphereCalib(initialPlatParams, dataSphere1, dataSphere2, r)
  initialPlatParams
  ...
  function cost = f(platParams)
    ...
    cost = c1 + c2 + 10*sum(residu1.^2) + 10*sum(residu2.^2)
  endfunction
